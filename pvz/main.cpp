...
//ImGui_ImplWin32_EnableDpiAwareness();
    ...
    io.ConfigViewportsNoAutoMerge = true; //脱离d3d窗口
    ...
    colors[ImGuiCol_Button] = ImColor(81,81,81,255);
    colors[ImGuiCol_ButtonHovered] = ImColor(71,71,71,255);
    colors[ImGuiCol_ButtonActive] = ImColor(81, 81, 81, 255);
